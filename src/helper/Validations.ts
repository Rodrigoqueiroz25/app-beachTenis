...
import { dateDayActual, parseDateString, stringToDate } from "./convertData";
...
export class Validations {
    ...
    public static formEditTournament = yup.object().shape({
        description: yup.string().required("Digite uma descrição"),
        ...
        dtStartRegistration: yup.string().required("digite uma data"),
        dtFinalRegistration: yup.string().required("digite uma data"),
        dtStartTournament: yup.string().required("digite uma data"),
        dtFinalTournament: yup.string().required("digite uma data"),
        otherInformation: yup.string()
    });

    public static formCreateTournament = yup.object().shape({
        description: yup.string().required("Digite uma descrição"),
        organization: yup.string().required("Digite algo"),
        cityId: yup.string().required("selecione uma opção"),
        sportId: yup.string().required("selecione uma opção"),
        dtStartRegistration: yup.date().typeError("digite uma data").min(dateDayActual(), "data deve ser igual ou posterior a atual"),
    ...
    public static fieldsDateFormTournament = yup.object().shape({
        dtStartRegistration: yup.date().typeError("digite uma data").min(dateDayActual(), "data deve ser igual ou posterior a atual"),
        dtFinalRegistration: yup.date().nullable().typeError("digite uma data")
            .test("dateTest", "data final de registro deve ser igual ou posterior a inicial", function (value) {
                return this.parent.dtStartRegistration <= (value as Date);
