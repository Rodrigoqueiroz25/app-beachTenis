...
export function MainContentHome({ cities, tournaments }: MainContentHomeProps) {
    ...
    function handleClickViewAllTournaments() {
        navigate(`${Routes.listTournaments}?progress=opened`);
    }
                            ...
                            <div className={styles.wrapper}>
                                <PostLogged.Item.Wrapper>
                                    <div className={styles.itemList}>
                                        ...
                                        {!isAdmin() &&
                                            <Button small onClick={() => navigate(`${Routes.tournamentLessParam}/${tournament.id}?display=categories`)}>Inscrição</Button>
                                        }
